  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" max-height=500px>
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item active">
        <!--このホテルの画像-->
        <img class="d-block w-80" src="{{ asset('hotelImages/ optional($hotel)->h_img') }}" x="0" y="0"  width="auto" height="300"/>
       
        <!--<p>...</p>-->
      </div>
      
      <div class="carousel-item">
        <img class="d-block w-80" src="{{ asset('hotelImages/ 3hoAkcgE4zuMn9Czcwidlkj9MsnfhxMl.jpg') }}" width="auto" height="300">
